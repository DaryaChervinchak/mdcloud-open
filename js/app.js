    ...
    (() => {
        ...
        function addTouchClass() {
            if (isMobile.any()) {
                ...
                if (menuArrows.length) for (let index = 0; index < menuArrows.length; index++) {
        ...
        function initSliders() {
            if (document.querySelector(".slider-main-news ")) new core(".slider-main-news", {
                ...
                loop: true,
                pagination: {
                    el: ".slider-main-news__swiper-pagination",
                    clickable: true
                },
                navigation: {
            ...
            if (document.querySelector(".navigation-products-tabs")) {
                const thumbsSwiper = new core(".navigation-products-tabs", {
        ...
        window.addEventListener("DOMContentLoaded", (function() {
            ...
            let checkboxItems = document.querySelectorAll(".js-checkbox");
            ...
            if (jsForm.length > 0) $(".js-form").on("submit", (function(e) {
                e.preventDefault();
                const form = $(this);
                form.ajaxSubmit({
                    crossDomain: true,
            ...
            let filterStories = document.querySelectorAll(".filter-stories");
            if (filterStories.length) {
                let selectedOptions = {};
                let itemClients = document.querySelectorAll(".js-clients");
                let countInfo = document.querySelector(".stories-all__count");
                let count = 0;
                function writeAllCountCase(count) {
                    if (count > 0) countInfo.classList.add("visually-hidden"); else countInfo.classList.remove("visually-hidden");
                }
                document.addEventListener("selectCallback", (function(e) {
                    const currentSelect = e.detail.select;
                    let currentSelectOptionData = currentSelect.options[currentSelect.selectedIndex].dataset;
                    for (let key in currentSelectOptionData) selectedOptions[key] = currentSelectOptionData[key];
                    for (let index = 0; index < itemClients.length; index++) {
                        const itemClient = itemClients[index];
                        itemClient.classList.remove("visually-hidden");
                        for (let title in selectedOptions) if (selectedOptions[title] != itemClient.dataset[title] && "" !== selectedOptions[title]) itemClient.classList.add("visually-hidden");
                        if (!itemClient.classList.contains("visually-hidden")) count++;
                    }
                    writeAllCountCase(count);
                    count = 0;
                }));
            }
        }));
